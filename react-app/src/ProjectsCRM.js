...
const ProjectsCRM = ({ AuthUser, application, re_render }) => {
  // Loading
  ...
  const validate = () => {
    const { Project_Name, Org, Token, Cookie } = newProject;
    const errors = {};
